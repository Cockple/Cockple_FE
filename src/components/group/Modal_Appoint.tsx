      ...
      >
          ...
          <div className="flex flex-col items-center text-center gap-1 mb-4 leading-snug">
              ...
              <p className="header-h4">
                {isDismiss ? "부모임장을 해제하시겠어요?" : "부모임장으로 지정하시겠어요?"}
              </p>
              <p className="body-rg-500 mt-1">
                {isDismiss ? "'수정하기'를 누르시면," : "'지정하기'를 누르시면, 부모임장에게"}
              </p>
              <p className="body-rg-500">
                {isDismiss ? "부모임장의 권한이 해제됩니다." : "모임 운영의 전반적인 권한이 부여돼요."}
              </p>
          </div>

          <div className="flex justify-center">
              <GY800_S
                label={isDismiss ? "수정하기" : "지정하기"}
                onClick={onConfirm} 
              />
          </div>
      </div>
